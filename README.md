# An web based image classifier to classify cricketer (https://www.kaggle.com/anandpuntambekar/end-to-end-image-classification-for-cricketers) models on [Render](https://render.com)
